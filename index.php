                ...
                <div class="body_top-ratings-brands-child">
                    ...
                    <div class="body_bot-ratings">
                        <div class="body_bot-ratings-item">
                            <a href="#">
                                <img src="./assets/img/ironman4.png" class="img_ratings-item">
                            </a>
                            <div class="body_bot-ratings-info">
                                <span class="ratings-info_text">Ironman</span>
                                <span>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                        ...
                        <div class="body_bot-ratings-item">
                            <a href="#">
                                <img src="./assets/img/kaido.png" class="img_ratings-item">
                            </a>
                            <div class="body_bot-ratings-info">
                                <span class="ratings-info_text">Kaido</span>
                                <span>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                        ...
                        <div class="body_bot-ratings-item">
                            <a href="#">
                                <img src="./assets/img/venom.png" class="img_ratings-item">
                            </a>
                            <div class="body_bot-ratings-info">
                                <span class="ratings-info_text">Venom</span>
                                <span>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                                ...
                                <span class="info_price">110$</span>
                            </div>
                        </div>
                        <div class="body_bot-ratings-item">
                            <a href="#">
                                <img src="./assets/img/madara.png" class="img_ratings-item">
                            </a>
                            <div class="body_bot-ratings-info">
                                <span class="ratings-info_text">Madara</span>
                                <span>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                                    <i class="fa-solid fa-star icon_star"></i>
                                ...
                                <span class="info_price">200$</span>
                            </div>
                        </div>
                    </div>
                </div>
